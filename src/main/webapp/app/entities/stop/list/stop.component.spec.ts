...
describe('Stop Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'stop', component: StopComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stops?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to stopService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStopIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStopIdentifier).toHaveBeenCalledWith(entity);
